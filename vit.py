...
def drop_path(x, drop_prob: float = 0., training: bool = False):
    # a module implementing stochastic depth. It randomly drops paths in the network during training to regularize and improve generalization.
...
# MachineLearningPerceptronBlock
class Mlp(nn.Module):
