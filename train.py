...
clip_model, ViT_preprocess = load("ViT-L/14", device=device,download_root='model') #Select image feature extractor
...
def main(args):
    ...
    print (f"train_tsfm ", train_tsfm)
    print (f"valid_tsfm ", valid_tsfm)
