...
class MultiModalAttrDataset(data.Dataset):
    ...
    def __init__(self, split, args, transform=None, target_transform=None):
        ...
        dataset_dir='/home/jerryum/works/OpenPAR/dataset/' #Set this to the directory where the dataset is located
...
def get_eval_transform(args):
    ...
    print('get_eval_transform height:', height)
    print('get_eval_transform width:', width)
