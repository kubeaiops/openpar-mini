...
import log_utils
from util import AverageMeter, to_scalar, time_str
...
def valid_trainer(model, clip_model, valid_loader, criterion,args):
    ...
    print ('preds_probs size', preds_probs.size)
    print ('image_list size', image_list.size)


    return valid_loss, gt_label, preds_probs, image_list
